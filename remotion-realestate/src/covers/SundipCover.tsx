    ...
    <AbsoluteFill style={{ backgroundColor: 'transparent', fontFamily: FONTS.text }}>
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, zIndex: 1 }}>
        ...
        <div style={{ padding: '44px 60px 0' }}>
          ...
          <div style={{ fontSize: 72, color: '#FFFFFF', fontWeight: 900, marginTop: 8, textShadow: SHADOW }}>{propertyName}</div>
        </div>
      </div>
        ...
        <div style={{ padding: '0 60px 0' }}>
          <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: 24 }}>
            <div style={{ textAlign: 'right' }}>
              ...
              <div style={{ fontSize: 52, color, fontWeight: 900, textShadow: SHADOW, marginBottom: 20 }}>{highlightLabel}</div>
              {tags.length > 0 && (
