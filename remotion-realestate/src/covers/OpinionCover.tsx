    ...
    <AbsoluteFill style={{ backgroundColor: 'transparent', fontFamily: FONTS.text }}>
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, zIndex: 1 }}>
        ...
        <div style={{ padding: '50px 60px 0' }}>
          ...
          <h1 style={{ fontFamily: FONTS.display, fontSize: 130, color: '#FFFFFF', lineHeight: 1.04, fontWeight: 900, margin: 0, textShadow: SHADOW, letterSpacing: '-0.03em' }}>
        ...
        <div style={{ padding: '0 60px 0' }}>
          <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: 28 }}>
            <div style={{ maxWidth: '78%' }}>
              ...
              <p style={{ fontSize: 56, color: '#FFFFFF', fontWeight: 900, lineHeight: 1.2, margin: 0, textAlign: 'right', textShadow: SHADOW }}>{hook}</p>
            </div>
          </div>
        </div>
